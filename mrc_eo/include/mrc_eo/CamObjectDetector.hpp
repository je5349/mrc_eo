...
class CamObjectDetector {
 public:
  /*!
   * Constructor.
   */
  explicit CamObjectDetector(ros::NodeHandle nh);
 ...
 private:
  ...
  //! Using.
  using CheckForObjectsActionServer = actionlib::SimpleActionServer<mrc_eo_msgs::CheckForObjectsAction>;
  ...
  mrc_eo_msgs::BoundingBoxes boundingBoxesResults_;
